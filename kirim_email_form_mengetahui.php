...
$mengetahui = $dpenilaian['mengetahui_1'];
...
if ($divisi2 == 'NONE')
{
    ...
    <!-- PRODUCTION:
    <h1 style="color:#777676;"><center><a href ="https://resikcemerlang.com/penilaian/update_approval_1.php?id='.$id.'"> Approve </a>
    &nbsp;&nbsp;<a href ="https://resikcemerlang.com/penilaian/edit_penilaian1.php?id='.$id.'"> Reject </a></center></h1>
    -->
    <h1 style="color:#777676;"><center><a href ="https://resikcemerlang.com/penilaian/update_approval_1.php?id='.$id.'"> Approve </a>
    &nbsp;&nbsp;<a href ="https://resikcemerlang.com/penilaian/edit_penilaian1.php?id='.$id.'"> Reject </a></center></h1>
...
// {
   var email = "<?php echo isset($email_mengetahui) ? $email_mengetahui : ''; ?>";
