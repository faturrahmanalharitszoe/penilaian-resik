...
$email_menyetujui = $dmenyetujui['email'];
...
<h2 style="color:#777676;"><center>Bpk/Ibu '.$menyetujui.'</center></h2>
...
<!-- PRODUCTION:
    <h1 style="color:#777676;"><center><a href ="https://resikcemerlang.com/penilaian/approve.php?id='.$id.'"> Approve </a>
&nbsp;&nbsp;<a href ="https://resikcemerlang.com/penilaian/edit_penilaian3.php?id='.$id.'"> Reject </a></center></h1>
    -->
    <h1 style="color:#777676;"><center><a href ="https://resikcemerlang.com/penilaian/approve.php?id='.$id.'"> Approve </a>
    &nbsp;&nbsp;<a href ="https://resikcemerlang.com/penilaian/edit_penilaian3.php?id='.$id.'"> Reject </a></center></h1>
...
$mail->addAddress($email_menyetujui);
...
// {
   var email = "<?php echo isset($email_menyetujui) ? $email_menyetujui : ''; ?>";
