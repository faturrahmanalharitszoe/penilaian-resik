        ...
        <style>
            ...
            <form action="update_form_edit3.php?id=<?php echo $id;?>" method="post" id="form" role="form" enctype="multipart/form-data">
                ...
                <div class="form-content">
		            ...
		            <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                        <label>Nama</label>
					    <input type="text" name="nama" class="form-control" readonly id="nama" value="<?php echo $dnilai['karyawan']; ?>" />
                    </div><br>
	                ...
	                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_1" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_1']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_1" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_1']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_1"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_2" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_2']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_2" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_2']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_2"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_3" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_3']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_3" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_3']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_3"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_4" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_4']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_4" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_4']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_4"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
			            ...
			            <textarea rows="1" maxlength="80" name="catatan1" id="catatan1" class="form-control" readonly> <?php echo '1. '.$dnilai['catatan1'];?> </textarea>
                        <textarea rows="1" maxlength="80" name="catatan11" id="catatan11" class="form-control" readonly> <?php echo '2. '.$dnilai['catatan11'];?> </textarea>
                    </div><br>
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_5" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_5']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_5" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_5']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_5"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_6" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_6']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_6" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_6']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_6"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_7" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_7']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_7" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_7']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_7"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_8" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_8']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_8" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_8']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_8"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_9" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_9']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_9" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_9']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_9"
				    ...
				    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_10" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_10']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_10" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_10']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_10"
				    ...
				    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_11" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_11']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_11" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_11']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_11"
				    ...
				    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
			            ...
			            <textarea rows="1" maxlength="80" name="catatan2" id="catatan2" class="form-control" readonly > <?php echo '1. '.$dnilai['catatan2'];?> </textarea>
                        <textarea rows="1" maxlength="80" name="catatan21" id="catatan21" class="form-control" readonly > <?php echo '2. '.$dnilai['catatan21'];?> </textarea>
                    </div><br>
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_12" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_12']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_12" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_12']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_12"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_13" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_13']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_13" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_13']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_13"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_14" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_14']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_14" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_14']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_14"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_15" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_15']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_15" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_15']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_15"
                    ...
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_16" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_16']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_16" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_16']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_16"
				    ...
				    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
					    ...
					    <input type="radio" name="nilai3_17" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_17']=="0") echo "checked";?> value="0"> N/A
			            <input type="radio" name="nilai3_17" style="cursor:pointer;"
                            <?php if ($dnilai['nilai1_17']=="1") echo "checked";?> value="1"> 1
                        <input type="radio" name="nilai3_17"
				    ...
				    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
			            ...
			            <textarea rows="1" maxlength="80" name="catatan3" id="catatan3" class="form-control" readonly> <?php echo '1. '.$dnilai['catatan3'];?> </textarea>
                        <textarea rows="1" maxlength="80" name="catatan31" id="catatan31" class="form-control" readonly> <?php echo '2. '.$dnilai['catatan31'];?> </textarea>
                    </div><br>
                    <hr>
                    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                        <label for="catatan4"> Catatan :  </label>
			            <textarea rows="1" maxlength="80" name="catatan4" id="catatan4" class="form-control" > </textarea>
                    </div><br>
                    <div class="row">
