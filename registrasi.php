  ...
  <body>
    ...
    <div class="col-md-8 offset-md-2">
        <div class="text-white form-header">
          <h3 class="text-center header"><b> Registrasi </b></h3>
        </div>
	<form action="daftar.php" method="post" id="form" role="form" enctype="multipart/form-data">	
      <div class="form-content">
	    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
          <label for="email">Alamat Email <a style="color:red">*</a></label>
          <input type="email" name="email" class="form-control" id="email" placeholder="Your Answer" required>
        </div>
		<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
        ...
        <div class="row">
          <div class="col-12 text-center">
			...
			<button class="btn btn-primary" ><span class="glyphicon glyphicon-floppy-disk"></span> REGISTER</button>
          </div>
        </div>
      </div>
    </form>
