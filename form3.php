    ...
    <style>
        ...
        <form action="update_form.php" method="post" id="form" role="form" enctype="multipart/form-data">
            ...
            <div class="form-content">
	            ...
	            <hr>
	            <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai1"> Efektifitas & Efisiensi Kerja <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai2"> Ketepatan waktu dalam mengerjakan tugas (Reporting) <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai3"> Memiliki Skill/kemampuan yang memadai pada bidangnya <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai4"> Kemampuan mencapai target/ standar Perusahaan  <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai5"> Merealisasikan Pekerjaan Sesuai Job Desc <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai6"> Responsif dalam komunikasi (Email, WhatsApp, Telepon) <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai7"> Teliti dan cermat dalam menyelesaikan pekerjaan <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai8"> Tertib Administrasi <a style="color:red">*</a></label><br>
                ...
                <h6><b> ASPEK NON TEKNIS </b></h6>
	            <hr>
                
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai9"> Inisiatif <a style="color:red">*</a></label><br>
				...
				<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai10"> Integritas <a style="color:red">*</a></label><br>
				...
				<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai11"> Kerjasama & Koordinasi antar bagian <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai12"> Tanggung Jawab dan Loyalitas <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai13"> Perilaku dan Sikap <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai14"> Akuntabilitas <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai15"> Kedisiplinan <a style="color:red">*</a></label><br>
	            ...
	            <hr>
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai16"> Koordinasi anggota dan Kontrol anggota <a style="color:red">*</a></label><br>
				...
				<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai17"> Ketepatan dan Kecepatan dalam Pengambilan Keputusan <a style="color:red">*</a></label><br>
                ...
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai18"> Evaluasi dan pembinaan anggota <a style="color:red">*</a></label><br>
			        <input type="radio" required name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="1") echo "checked";?>value="1"> 1 
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="2") echo "checked";?>value="2"> 2
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="3") echo "checked";?>value="3"> 3
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="4") echo "checked";?>value="4"> 4
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="5") echo "checked";?>value="5"> 5
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="6") echo "checked";?>value="6"> 6
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="7") echo "checked";?>value="7"> 7
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="8") echo "checked";?>value="8"> 8
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="9") echo "checked";?>value="9"> 9
                    <input type="radio" name="nilai18" style="cursor:pointer;"
                        <?php if (isset($nilai18) && $nilai18=="10") echo "checked";?>value="10"> 10
                </div><br>
				<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="nilai19"> Delegasi tanggung jawab dan wewenang <a style="color:red">*</a></label><br>
			        <input type="radio" required name="nilnilai19ai17" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="1") echo "checked";?>value="1"> 1 
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="2") echo "checked";?>value="2"> 2
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="3") echo "checked";?>value="3"> 3
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="4") echo "checked";?>value="4"> 4
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="5") echo "checked";?>value="5"> 5
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="6") echo "checked";?>value="6"> 6
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="7") echo "checked";?>value="7"> 7
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="8") echo "checked";?>value="8"> 8
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="9") echo "checked";?>value="9"> 9
                    <input type="radio" name="nilai19" style="cursor:pointer;"
                        <?php if (isset($nilai19) && $nilai19=="10") echo "checked";?>value="10"> 10
                </div><br>
				<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
