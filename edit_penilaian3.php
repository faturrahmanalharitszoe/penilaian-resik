...
<!DOCTYPE html>
    ...
    <style>
        ...
        <form action="update_form_edit3.php?id=<?php echo $id;?>" method="post" id="form" role="form" enctype="multipart/form-data">
            <div class="text-white form-header">
                <h3 class="text-center header"><b> Revisi Form Penilaian Karyawan </b></h3>
            </div>
            <div class="form-content">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h4 class="header mb-0"><b>Selamat Datang Bpk/Ibu <?php echo $penilai; ?></b></h4>  
                ...
                <input type="hidden" name="tgl" class="form-control" id="tgl" -->
...
<!-- class="form-control" id="penilai" placeholder="Your Answer" value="<?php echo $penilai; ?>" />
                <input type="hidden" name="email" class="form-control" id="email" placeholder="Your Answer" value="<?php echo $email; ?>" />
                <input type="hidden" name="tgl" class="form-control" id="tgl" placeholder="Your Answer" required -->
                </div>
	            <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
	                <label>Jabatan</label>
...
<input type="text" name="nama" class="form-control" readonly id="nama" value="<?php echo $karyawan; ?> - <?php echo $golongan;?> - <?php echo $divisi;?>" /> 
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_1'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_1" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_1'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_2'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_2" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_2'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_3'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_3" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_3'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_4'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_4" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_4'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_5'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_5" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_5'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_6'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_6" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_6'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_7'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_7" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_7'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_8'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_8" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_8'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
        ...
        <textarea rows="3" maxlength="80" name="catatan11" id="catatan11" class="form-control" readonly> <?php echo $dnilai['catatan1'];?> </textarea>
        <textarea rows="3" maxlength="80" name="catatan111" id="catatan111" class="form-control" > </textarea>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_9'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_9" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_9'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_10'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_10" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_10'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_11'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_11" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_11'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_12'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_12" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_12'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_13'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_13" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_13'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_14'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_14" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_14'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_15'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_15" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_15'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
        ...
        <textarea rows="3" maxlength="80" name="catatan21" id="catatan21" class="form-control" readonly> <?php echo $dnilai['catatan2'];?> </textarea>
        <textarea rows="3" maxlength="80" name="catatan211" id="catatan211" class="form-control" > </textarea>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_16'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_16" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_16'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_17'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_17" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_17'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_18'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_18" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_18'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        <?php for($v=1; $v<=10; $v++): ?>
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai3_19'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai4_19" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai3_19'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
        ...
        <textarea rows="3" maxlength="80" name="catatan31" id="catatan31" class="form-control" readonly> <?php echo $dnilai['catatan3'];?> </textarea>
        <textarea rows="3" maxlength="80" name="catatan311" id="catatan311" class="form-control" > </textarea>
    
                </div><br>
                
                    
                <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
                    <label for="catatan4"> CATATAN TAMBAHAN : </label>
			        <textarea rows="3" maxlength="80" name="catatan41" id="catatan41" class="form-control" readonly> <?php echo $dnilai['catatan4'];?> </textarea>
                    <textarea rows="3" maxlength="80" name="catatan411" id="catatan411" class="form-control" > </textarea>
                </div><br>
                    <div class="mt-3 d-flex justify-content-between">
...
<br><div class='text-center'>
            <button class="btn btn-primary" ><span class="glyphicon glyphicon-floppy-disk"></span> SIMPAN REVISI (APPROVE)</button>
        ...
        // Jika status BUKAN PENYETUJU, tampilkan pesan error
        ?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1">
            <title>Form Tidak Tersedia</title>
            <link rel="stylesheet" href="assets/css/bootstrap.css">
        </head>
        <body style="background-color: #f4f6f9;">
            <div class="container mt-5 text-center" style="padding-top: 50px;">
                <div class="alert alert-warning" style="display: inline-block; padding: 30px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color: #856404;"><b>MAAF, FORM TIDAK TERSEDIA</b></h4>
                    <p style="margin-top: 15px; font-size: 16px;">
                        Form penilaian ini sudah diproses sebelumnya atau sudah masuk ke tahap selanjutnya.<br>
                        Anda tidak dapat mengedit form ini lagi.
                    </p>
                    <a href="javascript:window.close();" class="btn btn-secondary mt-3">Tutup Halaman</a>
                </div>
            </div>
        </body>
        </html>
