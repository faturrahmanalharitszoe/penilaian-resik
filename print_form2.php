...
if ($pdf->GetStringWidth($txt_nama) > 7.6) {
   ...
   $pdf->Cell(18.8, 0.53, 'CATATAN :', 'LR', 1, 'L');
    ...
    $pdf->Cell(2.07, 0.53, $total_nilai3, 1, 0, 'C');
    ...
    $pdf->Cell(2.07, 0.53, $rata_nilai3, 1, 0, 'C');
    ...
    $pdf->Cell(2.07, 0.53, $grade_nilai3, 1, 0, 'C');
   ...
   $pdf->Cell(18.8, 0.53, 'CATATAN APPROVAL :', 'LR', 1, 'L');
    ...
    {
        ?>
        <IFRAME SRC="kirim_email_form.php?id=<?php echo $id;?>&nama=<?php echo $mengetahui_2;?>&pdf=<?php echo $fpdf;?>" WIDTH=0 HEIGHT=0></IFRAME>
        <?php if ($menyetujui != '-' && $menyetujui != '') { ?>
	        <IFRAME SRC="kirim_email_form_menyetujui.php?id=<?php echo $id;?>&pdf=<?php echo $fpdf;?>" WIDTH=0 HEIGHT=0></IFRAME>
        <?php } ?>
	    <!--<IFRAME SRC="kirim_email_form_mengetahui.php" WIDTH=0 HEIGHT=0></IFRAME>-->
	    <!--<IFRAME SRC="kirim_email_form_menyetujui.php" WIDTH=0 HEIGHT=0></IFRAME>-->
	    <!DOCTYPE html>
        <html>
        <head>
        ...
        <script>
            ...
            function showPage() 
            {
	            ...
	            alert("Menunggu Persetujuan Bpk/Ibu "+menyetujui);
