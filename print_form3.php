...
if ($pdf->GetStringWidth($txt_nama) > 7.6) {
   ...
   $pdf->SetX(11.3);
   $pdf->Cell(1.7, 0.6, 'NILAI I', 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.6, 'NILAI II', 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.6, 'NILAI III', 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.6, 'NILAI IV', 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.6, 'AKHIR', 'LBR', 1, 'C');
   ...
   $pdf->SetX(11.3);
   $pdf->Cell(1.7, 0.53, $nilai1_1, 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.53, $nilai2_1, 'LBR', 0, 'C');
   if($nilai3_1 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai3_1, 'LBR', 0, 'C'); }
   if($nilai4_1 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai4_1, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, 0.53, $akhir1, 'LBR', 1, 'C');
   $txt = $kriteria[1];
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_2, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_2, 'LBR', 0, 'C');
   if($nilai3_2 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_2, 'LBR', 0, 'C'); }
   if($nilai4_2 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_2, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir2, 'LBR', 1, 'C');
   $txt = $kriteria[2];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_3, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_3, 'LBR', 0, 'C');
   if($nilai3_3 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_3, 'LBR', 0, 'C'); }
   if($nilai4_3 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_3, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir3, 'LBR', 1, 'C');
   $txt = $kriteria[3];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_4, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_4, 'LBR', 0, 'C');
   if($nilai3_4 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_4, 'LBR', 0, 'C'); }
   if($nilai4_4 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_4, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir4, 'LBR', 1, 'C');
   $txt = $kriteria[4];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_5, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_5, 'LBR', 0, 'C');
   if($nilai3_5 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_5, 'LBR', 0, 'C'); }
   if($nilai4_5 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_5, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir5, 'LBR', 1, 'C');
   $txt = $kriteria[5];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_6, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_6, 'LBR', 0, 'C');
   if($nilai3_6 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_6, 'LBR', 0, 'C'); }
   if($nilai4_6 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_6, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir6, 'LBR', 1, 'C');
   $txt = $kriteria[6];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_7, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_7, 'LBR', 0, 'C');
   if($nilai3_7 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_7, 'LBR', 0, 'C'); }
   if($nilai4_7 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_7, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir7, 'LBR', 1, 'C');
   $txt = $kriteria[0];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_8, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_8, 'LBR', 0, 'C');
   if($nilai3_8 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_8, 'LBR', 0, 'C'); }
   if($nilai4_8 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_8, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir8, 'LBR', 1, 'C');
   ...
   $pdf->Cell(9.1, 0.53, $kriteria[0], 'LBR', 0, 'L');
   $pdf->SetX(11.3);
   $pdf->Cell(1.7, 0.53, $nilai1_9, 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.53, $nilai2_9, 'LBR', 0, 'C');
   if($nilai3_9 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai3_9, 'LBR', 0, 'C'); }
   if($nilai4_9 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai4_9, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, 0.53, $akhir9, 'LBR', 1, 'C');
   $txt = $kriteria[1];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '2', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_10, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_10, 'LBR', 0, 'C');
   if($nilai3_10 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_10, 'LBR', 0, 'C'); }
   if($nilai4_10 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_10, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir10, 'LBR', 1, 'C');
   $txt = $kriteria[2];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '3', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_11, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_11, 'LBR', 0, 'C');
   if($nilai3_11 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_11, 'LBR', 0, 'C'); }
   if($nilai4_11 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_11, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir11, 'LBR', 1, 'C');
   $txt = $kriteria[3];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '4', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_12, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_12, 'LBR', 0, 'C');
   if($nilai3_12 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_12, 'LBR', 0, 'C'); }
   if($nilai4_12 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_12, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir12, 'LBR', 1, 'C');
   $txt = $kriteria[4];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '5', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_13, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_13, 'LBR', 0, 'C');
   if($nilai3_13 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_13, 'LBR', 0, 'C'); }
   if($nilai4_13 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_13, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir13, 'LBR', 1, 'C');
   $txt = $kriteria[5];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '6', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_14, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_14, 'LBR', 0, 'C');
   if($nilai3_14 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_14, 'LBR', 0, 'C'); }
   if($nilai4_14 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_14, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir14, 'LBR', 1, 'C');
   $txt = $kriteria[6];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '7', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_15, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_15, 'LBR', 0, 'C');
   if($nilai3_15 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_15, 'LBR', 0, 'C'); }
   if($nilai4_15 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_15, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir15, 'LBR', 1, 'C');
   $pdf->Cell(18.8, 0.53, 'CATATAN :', 'LR', 1, 'L');
   if($catatan21 == '')
    {
   ...
   $pdf->Cell(9.1, 0.53, $kriteria[0], 'LBR', 0, 'L');
   $pdf->SetX(11.3);
   $pdf->Cell(1.7, 0.53, $nilai1_16, 'LBR', 0, 'C');
   $pdf->Cell(1.7, 0.53, $nilai2_16, 'LBR', 0, 'C');
   if($nilai3_16 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai3_16, 'LBR', 0, 'C'); }
   if($nilai4_16 == '0') { $pdf->Cell(1.7, 0.53, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, 0.53, $nilai4_16, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, 0.53, $akhir16, 'LBR', 1, 'C');
   $txt = $kriteria[1];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '2', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
   $pdf->Cell(1.7, $h, $nilai1_17, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_17, 'LBR', 0, 'C');
   if($nilai3_17 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_17, 'LBR', 0, 'C'); }
   if($nilai4_17 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_17, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir17, 'LBR', 1, 'C');
   $txt = $kriteria[2];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '3', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
    $pdf->Cell(1.7, $h, $nilai1_18, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_18, 'LBR', 0, 'C');
   if($nilai3_18 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_18, 'LBR', 0, 'C'); }
   if($nilai4_18 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_18, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir18, 'LBR', 1, 'C');
    $txt = $kriteria[3];
$h = ($pdf->GetStringWidth($txt) > 8.9) ? 1.06 : 0.53;
$pdf->Cell(1.2, $h, '4', 'LBR', 0, 'C');
$startX = $pdf->GetX();
...
$pdf->SetX(11.3);
    $pdf->Cell(1.7, $h, $nilai1_19, 'LBR', 0, 'C');
   $pdf->Cell(1.7, $h, $nilai2_19, 'LBR', 0, 'C');
   if($nilai3_19 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai3_19, 'LBR', 0, 'C'); }
   if($nilai4_19 == '0') { $pdf->Cell(1.7, $h, 'N/A', 'LBR', 0, 'C'); } else { $pdf->Cell(1.7, $h, $nilai4_19, 'LBR', 0, 'C'); }
   $pdf->Cell(1.7, $h, $akhir19, 'LBR', 1, 'C');
   $pdf->Cell(18.8, 0.53, 'CATATAN :', 'LR', 1, 'L');
   if($catatan31 == '')
    {
   ...
   $pdf->Cell(1.7, 0.53, $total_nilai1, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $total_nilai2, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $total_nilai3, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $total_nilai4, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $total_akhir, 1, 1, 'C');
   $pdf->Cell(10.3, 0.53, 'Rata - rata Nilai', 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $rata_nilai1, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $rata_nilai2, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $rata_nilai3, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $rata_nilai4, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $rata_akhir, 1, 1, 'C');
   $pdf->Cell(10.3, 0.53, 'Grade Nilai', 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $grade_nilai1, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $grade_nilai2, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $grade_nilai3, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $grade_nilai4, 1, 0, 'C');
   $pdf->Cell(1.7, 0.53, $grade_akhir, 1, 1, 'C');
   ...
   $pdf->Cell(4.7, 0.53, $menyetujui, 1, 0, 'C');
