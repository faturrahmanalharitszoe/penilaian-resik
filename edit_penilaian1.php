...
<!DOCTYPE html>
    ...
    <style>
        ...
        <form action="update_form_edit1.php?id=<?php echo $id;?>" method="post" id="form" role="form" enctype="multipart/form-data">
...
<input type="text" name="nama" class="form-control" readonly id="nama" value="<?php echo $karyawan; ?> - <?php echo $golongan;?> - <?php echo $divisi;?>" /> 
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_1'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_1" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_1'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_2'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_2" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_2'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_3'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_3" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_3'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_4'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_4" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_4'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_5'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_5" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_5'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_6'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_6" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_6'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_7'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_7" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_7'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_8'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_8" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_8'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_9'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_9" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_9'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_10'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_10" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_10'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_11'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_11" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_11'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_12'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_12" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_12'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_13'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_13" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_13'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_14'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_14" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_14'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_15'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_15" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_15'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_16'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_16" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_16'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_17'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_17" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_17'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_18'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_18" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_18'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
    ...
    <div class="btn-group btn-group-toggle d-flex radio-group-segmented w-100" data-toggle="buttons">
        ...
        <label class="btn btn-outline-secondary btn-score-<?php echo $v; ?> <?php if ($dnilai['nilai1_19'] == $v) echo 'active'; ?>" style="flex:1;">
            <input type="radio" required name="nilai2_19" value="<?php echo $v; ?>" autocomplete="off" class="score-radio" <?php if ($dnilai['nilai1_19'] == $v) echo 'checked'; ?>> <?php echo $v; ?>
        </label>
        <?php endfor; ?>
    </div>
