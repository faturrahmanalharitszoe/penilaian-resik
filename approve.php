   ...
   if ($status == 'PENYETUJU')
    {
        ...
        <form action="update_approval_3.php?id=<?php echo $id;?>" method="post" id="form" role="form" enctype="multipart/form-data">
            ...
            <div class="form-content">
                <h4 class="text-center header"><b>Selamat Datang Bpk/Ibu <?php echo $menyetujui; ?></b></h4>
