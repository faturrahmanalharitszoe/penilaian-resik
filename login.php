  ...
  <body>
    ...
    <div class="col-md-8 offset-md-2">
        <div class="text-white form-header">
            <h4 class="text-center header"><b> Form Penilaian Karyawan </b></h4>
            <h3 class="text-center header"><b> Login </b></h3>
        </div>
	<form action="proses_login.php" method="post" id="form" role="form" enctype="multipart/form-data">	
      <div class="form-content" style="border-radius: 0 0 33px 33px;">
	    <div class="col-6" style="margin-bottom:1rem;max-width:100%;">
          <label for="email">Alamat Email <a style="color:red">*</a></label>
          <input type="email" name="email" class="form-control" id="email" autofocus placeholder="Your Answer" required value="<?php echo $email; ?>" />
        </div>
		<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
            <label for="nama">Password <a style="color:red">*</a></label>
            <input type="password" name="password" id="password" autocomplete="current-password" placeholder="Your Answer" required class="form-control">
        </div>
		<div class="col-6" style="margin-bottom:1rem;max-width:100%;">
        ...
        <div class="row">
          <div class="col-12 text-center">
			...
			<button class="btn btn-primary" ><span class="glyphicon glyphicon-floppy-disk"></span> LOGIN </button>
			<a class="btn btn-danger" style="color:white;cursor:pointer;" onclick="location.href = 'registrasi.php'" ><span class="glyphicon glyphicon-log-out"></span> REGISTER </a><br><br>
