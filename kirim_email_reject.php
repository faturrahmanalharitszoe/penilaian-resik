...
$subject = '(No-Reply) - Reject Hasil Penilaian '.$nama; 
//$msg = $_POST['message']; 
$mailContent = '<h1 style="color:#777676;"><center>Hai,</center></h1>
<h1 style="color:#777676;"><center>'.$penilai.'</center></h1>
<hr style="color:#b8b7b7;">
<h3 style="color:#777676;"><center>Reject Hasil penilaian Karyawan</center></h3>
...
<hr style="color:#b8b7b7;">
<h5><b5></h5>
<h4 style="color:#777676;"><center>Silahkan klik link dibawah ini untuk Revisi Penilaian</center></h4>
<h1 style="color:#777676;"><center><a href ="https://resikcemerlang.com/penilaian/edit_penilaian.php?id='.$id.'"> Revisi </a></center></h1>
...
// {
   ...
   window.location.href = 'admin/index.php?pilih=1.1';
// }
 </script>
 <?php
//exit;
