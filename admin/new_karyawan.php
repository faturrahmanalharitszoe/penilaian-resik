            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<form action="simpan_karyawan.php" method="post" id="form" role="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							<input type="hidden" name="user" class="form-control" size="54px" width="10px;" value="<?php echo $user;?>" required />
						</div>
						<div class="form-group">
							<label> NIK Karyawan </label>
							<input type="text" name="nik" class="form-control" size="54px" width="10px;" required />
						</div>
						<div class="form-group">
							<label> Nama Karyawan <a style="color:red">*</a></label>
							<input type="text" name="nama" class="form-control" size="54px" required/>
						</div>
						<div class="form-group">
		                ...
		                <div class="form-group">
						    ...
						    <select id="divisi" name="divisi" class="form-control" required >  
			                    ...
			                    while($row=mysqli_fetch_array($select))
			                    {
								 echo "<option>".$row['nama_divisi']."</option>";
			                    }
			                    ?>
		                    </select>
		                </div> 
		                ...
		                <div class="form-group">
							...
							<input type="text" name="email" class="form-control" size="54px" />
						</div>
						<div class="form-group">
							<label> No Handphone </label>
							<input type="text" name="handphone" class="form-control" size="54px" />
						</div>
						<div class="form-group">
							<label> Tgl Efektif <a style="color:red">*</a></label>
							<input type="date" name="tgl_efektif" class="form-control" size="54px" required/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label> Jurusan </label>
							<input type="text" name="jurusan" class="form-control" size="54px" />
						</div>
