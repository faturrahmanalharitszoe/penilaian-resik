        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<form action="perubahan_karyawan.php" method="post" id="form" role="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" name="nik" class="form-control" size="54px" width="10px;" value="<?php echo $data['nik'];?>" readonly />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						    ...
						    <option value="<?php echo $data['golongan'];?>"><?php echo $data['golongan'];?></option>  
							 <?php
								 $select=mysqli_query($koneksi,"select * from golongan order by id");
								 while($row=mysqli_fetch_array($select))
								 {
								 echo "<option>".$row['golongan']."</option>";
								 }
							 ?>
						  </select>
		                </div> 
						...
						<div class="form-group">
						    ...
						    <select id="divisi2" name="divisi2" class="form-control" >  
		                    <option value="<?php echo $data['divisi2'];?>"><?php echo $data['divisi2'];?></option>  
			                    <?php
			                    $select=mysqli_query($koneksi,"select * from divisi order by id");
			                    while($row=mysqli_fetch_array($select))
			                    {
						...
						<div class="form-group">
						    <label> Divisi 3 </label>
						    <select id="divisi3" name="divisi3" class="form-control" >  
		                    <option value="<?php echo $data['divisi3'];?>"><?php echo $data['divisi3'];?></option>  
			                    <?php
			                    $select=mysqli_query($koneksi,"select * from divisi order by id");
			                    while($row=mysqli_fetch_array($select))
			                    {
						...
						<div class="form-group">
							...
							<input type="text" name="handphone" class="form-control" size="54px" value="<?php echo $data['no_hp'];?>"/>
						</div>
						<div class="form-group">
							<label> Tgl Efektif <a style="color:red">*</a></label>
							<input type="date" name="tgl_efektif" class="form-control" size="54px" value="<?php echo $data['tgl_masuk'];?>" required/>
						</div>
						<div class="form-group">
						    <label> Pendidikan <a style="color:red">*</a></label>
						    <select id="pendidikan" name="pendidikan" class="form-control" required >  
		                    <option value="<?php echo $data['pendidikan'];?>"><?php echo $data['pendidikan'];?></option>  
			                    <?php
			                    $select=mysqli_query($koneksi,"select * from pendidikan order by id");
			                    while($row=mysqli_fetch_array($select))
			                    {
			                        //echo "<option>".strtoupper($row['jabatan'])."</option>";
			                        ?>
						...
						<div class="form-group">
							<label> Jurusan </label>
							<input type="text" name="jurusan" class="form-control" size="54px" value="<?php echo $data['jurusan'];?>"/>
						</div>
                        <div class="form-group">
