                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Form
							 
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            
					<form action="perubahan_form.php" method="post" id="form" role="form" enctype="multipart/form-data">
						...
						?>
                        <div class="form-group">
							<input type="hidden" name="user" class="form-control" size="54px" width="10px;" value="<?php echo $user;?>" />
						</div>
						<div class="form-group">
							<label> Nama Form <a style="color:red">*</a></label>
							<input type="text" name="nama" class="form-control" size="54px" width="10px;" value="<?php echo $data['form'];?>" required />
						</div>
						<div class="form-group">
							<label> Jenis Form <a style="color:red">*</a></label>
							<input type="text" name="jenis" class="form-control" size="54px" value="<?php echo $data['jenis_form'];?>" required/>
						</div>
                        <div class="form-group">
							<label> Nama Perusahaan <a style="color:red">*</a></label>
							<input type="text" name="perusahaan" class="form-control" size="54px" value="<?php echo $data['company'];?>" required/>
						</div>
						<div class="form-group">
							<label> No Form <a style="color:red">*</a></label>
							<input type="text" name="nomor" class="form-control" size="54px" value="<?php echo $data['no_form'];?>" required/>
						</div>
		                <div class="form-group">
							<label> Judul Form <a style="color:red">*</a></label>
							<input type="text" name="judul" class="form-control" size="54px" value="<?php echo $data['judul_form'];?>" required/>
						</div>
						<div class="form-group">
							<label> Tgl Form <a style="color:red">*</a></label>
							<input type="text" name="tgl" class="form-control" size="54px" value="<?php echo $data['tgl_form'];?>" required/>
						</div>
