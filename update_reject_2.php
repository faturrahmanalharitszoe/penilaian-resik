<?php
	...
	$qupdate = mysqli_query($koneksi,"update penilaian set catatan_reject = '$catatan',reject='$dirut',tgl_reject='$tgl' where id = '$id'");
	if($qupdate)
	{
	   ...
	   <script>
		   ...
		   var win = window.open("https://resikcemerlang.com/penilaian/kirim_email_reject_2.php?id="+id+"&email="+email+"&nama="+nama, "win", "width=600,height=800");
	   </script>
	   <?php	
	}   
?>