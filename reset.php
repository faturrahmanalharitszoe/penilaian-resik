...
<html lang="en" dir="ltr">
  ...
  <body>
	...
	<form action="kirim_email_reset.php" method="post" id="form" role="form" enctype="multipart/form-data">	
      <div class="form-content">
        ...
        <div class="row">
          <div class="col-12 text-center">
			...
			<button class="btn btn-primary" ><span class="glyphicon glyphicon-floppy-disk"></span> RESET</button>
          </div>
        </div>
      </div>
    </form>
